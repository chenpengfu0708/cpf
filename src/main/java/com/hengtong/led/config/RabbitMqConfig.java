...
import com.hengtong.led.mqcallback.MsgSendConfirmCallBack;
...
public class RabbitMqConfig {
    ...
    /** 队列key1*/
    public static final String ROUTINGKEY1 = " fanout.A";
    /** 队列key2*/
    public static final String ROUTINGKEY2 = "fanout.B";
