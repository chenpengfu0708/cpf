...
public class Md5Util {
    ...
    public static void main(String[] args) {
        String a = "3008abdc-36be-49c0-bc33-08b23821ea00" + "ead9ass9da8ghjloaid0dk9dka456wq";
        //展翅md5
        String a2 = "a324abdc-36be-49c0-bc33-08b23821ea02" + "zsddcxzcz3jzczxffrdfsf48jnsdfsdf98798l";
        //百万三者
        String a3 = "00000001-36be-49c0-bc33-08b23821ea02" + "laymedtest8ghjloaid0dk9dka456wq";
        byte[] c = a.getBytes();
