...
public class MinioService {
    ...
    public String uploadToMinio(MultipartFile file) {
        try {
            ...
            minioClient.putObject(minioConfig.getBucketName(),file.getOriginalFilename(), file.getInputStream(), file.getContentType());
            System.out.println("successfully...");
            return minioClient.getObjectUrl(minioConfig.getBucketName(), file.getOriginalFilename());
        } catch(Exception e) {
